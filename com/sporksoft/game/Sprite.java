...
//                             Graphics.TOP | Graphics.LEFT);
            ...
            c.save();
            if (t_currentTransformation == TRANS_MIRROR ||
                    t_currentTransformation == TRANS_MIRROR_ROT90 ||
                    t_currentTransformation == TRANS_MIRROR_ROT180 ||
                    t_currentTransformation == TRANS_MIRROR_ROT270) {
                c.scale(-1, 1, x + dRefX, y + dRefY);                
            }
            switch ( t_currentTransformation) {
                ...
                case TRANS_MIRROR_ROT90:
                    c.rotate(90, x + dRefX, y + dRefY);
                    break;
                case TRANS_ROT180:
                case TRANS_MIRROR_ROT180:
                    c.rotate(180, x + dRefX, y + dRefY);
                    break;
                case TRANS_ROT270:
...
//    private void initializeFrames(Image image, int fWidth, 
    private void initializeFrames(Bitmap image, int fWidth, 
...
//                           "Sprite: t_currentTransformation=" + 
//                           this.t_currentTransformation);
            Log.e(getClass().getName(),  "Sprite: t_currentTransformation=" + 
                  this.t_currentTransformation);
...
//                             "Sprite: transform=" + transform);
          Log.e(getClass().getName(), "Sprite: transform=" + transform);
